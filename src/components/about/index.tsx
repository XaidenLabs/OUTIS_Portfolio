        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'
            ...
            <div ref={skillsRef}>
              ...
              <div className="mb-8 ">
                <h4 className="flex items-center  gap-2 text-2xl font-bold text-gray-900 mb-2">
                  Communities & <span className="text-indigo-600">Affiliation</span>

                </h4>
                <div className="list-disc ml-10 text-gray-700">
                  
                  <h2 className="font-bold">SuperteamNG</h2>
                  <p className="ml-4">Member & Writers&apos; Guild Lead</p>
                  <br />
                  <a href="https://x.com/SolanaCollectiv" className="font-bold underline">Solana Collective</a>
                  <p className="ml-4">Member / Active Contributor</p>
                </div>
              </div>
            </div>
          </div>
