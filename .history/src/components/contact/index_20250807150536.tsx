    ...
    <>
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          {/* Background blobs and pinging dots omitted for brevity */}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className={`transition-all duration-1000 delay-300 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-8 opacity-0"}`}>
              ...
              <div className={`transition-all duration-1000 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                ...
                <div className="flex space-x-4">
                  ...
                  <SocialLink icon={<FaXTwitter size={20} />} href="https://www.x.com/angry__pacifist" label="Twitter" delay={1000} />
            ...
            <div
              ref={formRef}
              className={`transition-all duration-1000 delay-500 ${formVisible ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"}`}
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Feel free to share what you're working on..."
                    />
          ...
          <div className={`mt-20 text-center transition-all duration-1000 delay-1200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
