...
import { ArrowRight, Github, Linkedn } from "lucide-react";
...
const Hero = () => {
  ...
  const words = ["Writer", "Comm. Manager", "S. Media Manager", "Content Creator", "Comm. Builder", "Digital Marketer", "Storyteller"];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-10 leading-relaxed max-w-lg opacity-0 animate-fade-in-up delay-700">
              ...
              <span className="text-indigo-600 font-semibold"> powerful storytelling</span> and
              <span className="text-purple-600 font-semibold"> meaningful connections</span>. Whether it&#39;s crafting compelling content or fostering vibrant communities, I create impact with purpose.
            </p>
