...
const Hero = () => {
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-10 leading-relaxed max-w-lg opacity-0 animate-fade-in-up delay-700">
              I work where <span className="text-indigo-600 font-semibold">technology</span> and <span className="text-purple-600 font-semibold">community</span> meet. Building the bridge between them by translating complex ideas into clear, insightful <span className="text-indigo-600 font-semibold">content</span> and creating supportive online <span className="text-purple-600 font-semibold">communities</span> where people truly feel they belong.
            </p>
  ...
  className="group border-2 border-indigo-200 text-indigo-700 px-8 py-4 rounded-xl hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-300 flex items-center justify-center font-semibold text-lg hover:scale-105 hover:-translate-y-1 backdrop-blur-sm cursor-pointer"
>
  View my Resume
</div>
            </div>
