          ...
          <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'
            ...
            <div className="relative space-y-8">
              <ExperienceCard
                ...
                Acted as a key content contributor for the ecosystem, ghostwriting landscape reports for SuperteamNG and authoring high-visibility content for the official <a href="https://x.com/LittleUnusualMY" target="_blank" rel="noopener noreferrer" style="text-decoration:underline;color:#6366f1;">solana</a>  Twitter (X) account.`}
