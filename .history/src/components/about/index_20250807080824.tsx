          ...
          <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'
            ...
            <div className="mb-12">
              <div className="prose prose-lg text-gray-600 leading-relaxed">
                <p className="mb-6">
                  I learned my most valuable professional lessons on the basketball court. The discipline from practice, the strategic thinking needed to win, and the chemistry that turns a group into a team are the same principles I bring to the digital world every day. <b></b>
