          ...
          <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'
            ...
            <div className="relative space-y-8">
              ...
              <ExperienceCard
                ...
                company="Superteam Nigeria (Nigeria)"
                location="Remote"
                period="September 2024 - Present"
                description="Spearheaded the guild's successful transition from a multi-platform structure (WhatsApp/Telegram) to a unified Discord server, maintaining high engagement during a period of widespread community restructuring.
                <br></br>

                Cultivated the guild into the premier hub for Solana writers in the region by hosting workshops, developing a 'deeper research bench,' and creating pathways for members to access earning opportunities.
                <br></br>

                Acted as a key content contributor for the ecosystem, ghostwriting landscape reports for SuperteamNG and authoring high-visibility content for the official Solana Twitter (X) account."
                techStack="Leadership, Community Strategy, Content Development, Talent Development, Ghostwriting, SolanaEcosystem"
                delay={0}
              />
            </div>
          </div>
